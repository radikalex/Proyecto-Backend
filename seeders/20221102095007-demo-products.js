    ...
    return queryInterface.bulkInsert('Products', [
      {
        ...
        img_product: 'products_images/default/seeder-product1.jpg',
        category_id: 1,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        img_product: 'products_images/default/seeder-product2.jpg',
        category_id: 2,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        img_product: 'products_images/default/seeder-product3.jpg',
        category_id: 3,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        img_product: 'products_images/default/seeder-product4.jpg',
        category_id: 4,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        img_product: 'products_images/default/seeder-product5.jpg',
        category_id: 5,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        img_product: 'products_images/default/seeder-product6.jpg',
        category_id: 6,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        img_product: 'products_images/default/seeder-product7.jpg',
        category_id: 2,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        img_product: 'products_images/default/seeder-product8.jpg',
        category_id: 3,
        createdAt: new Date(),
        updatedAt: new Date()
      }
